...
<div class="flex gap-32 items-center justify-center h-full">
    ...
    <table class="border-separate border-spacing-y-[0.75rem] border-spacing-x-0 max-w-2xl w-full">
        <tbody>
            <thead>
                <th colspan="2" class="bg-pink-700 -skew-x-12 py-6 text-4xl font-black">
            ...
            <tr class="">
                <td class="relative !bg-transparent">
                    <div class="px-4 py-2 bg-pink-500 -skew-x-12 absolute top-1/2 transform -translate-y-1/2 -left-5 shadow-[5px_5px_8px_-2px_rgb(0_0_0_/_0.5)]"><p class="skew-x-12 font-bold">{{ $loop->iteration }}</p></div>
                </td>
