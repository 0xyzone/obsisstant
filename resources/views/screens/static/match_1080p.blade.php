<x-screen1080>
    <div class="w-full h-full" style="background: url({{ $match->tournament->asset != null && isset($match->tournament->asset->background) ? asset('storage/' . $match->tournament->asset->background) : '' }});">
        ...
        <div class="flex items-center gap-4 justify-center mt-10">
            <div class="w-4/12 flex flex-col items-center border-4 rounded-2xl overflow-hidden shrink-0 aspect-square" style="border-color: {{$leftWin}};">
            ...
            <div class="w-4/12 flex flex-col items-center border-4 rounded-2xl overflow-hidden shrink-0 aspect-square" style="border-color: {{$rightWin}};">
